...
I include my prompt as BetterWriterPrompt.md that I used originally for you to clearly understand my goals with this project, with some small tweaks and fixes, and Plan.md for clear goal tracking and planning. You can make your suggestions for the plan.
